    ...
    if play1:
      ...
      if frame is not None:
        ...
        if task == "face_detection" and model1 == "Haar cascade":
          ...
          frame1 = FaceDetection().caffeeAndTensorModel(frame1, net, FPS().start())
          ...
          frame1 = FaceDetection().npd(frame1, npdModel, minFace, maxFace, overlap)
        ...
        if task == "face_detection" and model2 == "Haar cascade":
          ...
          frame2 = FaceDetection().caffeeAndTensorModel(frame2, net, FPS().start())
          ...
          npdModel = {n: np.array(v) for n, v in f.get('npdModel').items()}
          frame2 = FaceDetection().npd(frame2, npdModel, minFace, maxFace, overlap)
